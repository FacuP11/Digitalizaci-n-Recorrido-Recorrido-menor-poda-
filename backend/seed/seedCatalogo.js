...
(async () => {
  try {
    ...
    const items = [
      ...
      { categoria: 'CONDUCTORES', codigo: 'BALIZOR', descripcion: 'Balizor roto (N/D)', tipo_entrada: 'texto' },
    ...
    await ItemCatalogo.bulkCreate(items, {
      updateOnDuplicate: ['descripcion', 'tipo_entrada', 'max_value']
    });
